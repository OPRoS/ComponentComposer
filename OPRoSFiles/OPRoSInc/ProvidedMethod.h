...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive &in,
			boost::archive::polymorphic_oarchive &out) = 0;
...
class ProvidedMethod_0: public ProvidedMethod<RetType> {
	...
	template<typename R>
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
			boost::archive::polymorphic_oarchive & out) {
		R resultData;

		resultData = (*this)();

		out << BOOST_SERIALIZATION_NVP(resultData);
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
			boost::archive::polymorphic_oarchive & out) {
		return _call<typename boost::remove_const<
				typename boost::remove_reference<RetType>::type>::type> (in,
				out);
	}
...
class ProvidedMethod_1: public ProvidedMethod<RetType> {
	...
	template<typename R, typename TPA1>
	 inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param1);
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		return _call<typename boost::remove_const<
		typename boost::remove_reference<RetType>::type>::type,
...
class ProvidedMethod_2: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param1);
		in >> BOOST_SERIALIZATION_NVP(param2);
#ifdef _MSC_VER
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<RetType>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA1>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA2>::type>::type> (
				in, out);
	}
...
class ProvidedMethod_3: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param1);
		in >> BOOST_SERIALIZATION_NVP(param2);
		in >> BOOST_SERIALIZATION_NVP(param3);
...
class ProvidedMethod_4: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param2);
		in >> BOOST_SERIALIZATION_NVP(param3);
		in >> BOOST_SERIALIZATION_NVP(param4);
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA2>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA3>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA4>::type>::type> (
				in, out);
	}
...
class ProvidedMethod_5: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param3);
		in >> BOOST_SERIALIZATION_NVP(param4);
		in >> BOOST_SERIALIZATION_NVP(param5);
...
class ProvidedMethod_6: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param4);
		in >> BOOST_SERIALIZATION_NVP(param5);
		in >> BOOST_SERIALIZATION_NVP(param6);
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA4>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA5>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA6>::type>::type> (
				in, out);
	}
...
class ProvidedMethod_7: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param5);
		in >> BOOST_SERIALIZATION_NVP(param6);
		in >> BOOST_SERIALIZATION_NVP(param7);
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
			boost::archive::polymorphic_oarchive & out) {
		return _call<typename boost::remove_const<typename boost::remove_reference<RetType>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<PA1>::type>::type,
		typename boost::remove_const<	typename boost::remove_reference<PA2>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<PA3>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<PA4>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<PA5>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<PA6>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<PA7>::type>::type> (in, out);
	}
...
class ProvidedMethod_8: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param6);
		in >> BOOST_SERIALIZATION_NVP(param7);
		in >> BOOST_SERIALIZATION_NVP(param8);
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA6>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA7>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA8>::type>::type> (
				in, out);
	}
...
class ProvidedMethod_9: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param7);
		in >> BOOST_SERIALIZATION_NVP(param8);
		in >> BOOST_SERIALIZATION_NVP(param9);
...
class ProvidedMethod_10: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param8);
		in >> BOOST_SERIALIZATION_NVP(param9);
		in >> BOOST_SERIALIZATION_NVP(param10);
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA8>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA9>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA10>::type>::type> (
				in, out);
	}
...
class ProvidedMethod_11: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param9);
		in >> BOOST_SERIALIZATION_NVP(param10);
		in >> BOOST_SERIALIZATION_NVP(param11);
...
class ProvidedMethod_12: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param10);
		in >> BOOST_SERIALIZATION_NVP(param11);
		in >> BOOST_SERIALIZATION_NVP(param12);
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA10>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA11>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA12>::type>::type> (
				in, out);
	}
...
class ProvidedMethod_13: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param11);
		in >> BOOST_SERIALIZATION_NVP(param12);
		in >> BOOST_SERIALIZATION_NVP(param13);
...
class ProvidedMethod_14: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param12);
		in >> BOOST_SERIALIZATION_NVP(param13);
		in >> BOOST_SERIALIZATION_NVP(param14);
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA12>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA13>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA14>::type>::type> (
				in, out);
	}
...
class ProvidedMethod_15: public ProvidedMethod<RetType> {
	...
	inline ReturnType _call(boost::archive::polymorphic_iarchive & in,
		...
		in >> BOOST_SERIALIZATION_NVP(param13);
		in >> BOOST_SERIALIZATION_NVP(param14);
		in >> BOOST_SERIALIZATION_NVP(param15);
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
			boost::archive::polymorphic_oarchive & out) {
		return _call<typename boost::remove_const<
		typename boost::remove_reference<PA1>::type>::type> (in, out);
	}
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		return _call<typename boost::remove_const<
		typename boost::remove_reference<PA1>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA1>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA2>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA3>::type>::type> (
				in, out);
	}
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA3>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA4>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA5>::type>::type> (
				in, out);
	}
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA5>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA6>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA7>::type>::type> (
				in, out);
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA7>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA8>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA9>::type>::type> (
				in, out);
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA9>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA10>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA11>::type>::type> (
				in, out);
	}
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA11>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA12>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA13>::type>::type> (
				in, out);
	}
...
public:
	...
	virtual ReturnType call(boost::archive::polymorphic_iarchive & in,
		...
		typename boost::remove_reference<PA13>::type>::type,
		typename boost::remove_const<typename boost::remove_reference<
		PA14>::type>::type, typename boost::remove_const<
		typename boost::remove_reference<PA15>::type>::type> (
				in, out);
