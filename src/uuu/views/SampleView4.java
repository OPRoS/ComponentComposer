...
public class SampleView4 extends ViewPart {
 ...
 */
		private void initialize() {
			TreeParent to1 = new TreeParent("Leaf 1");
			TreeParent to2 = new TreeParent("Leaf 2");
			TreeParent to3 = new TreeParent("Leaf 3");
			TreeParent p1 = new TreeParent("Parent 1");
			p1.addChild(to1);
			p1.addChild(to2);
			p1.addChild(to3);
			
			TreeParent to4 = new TreeParent("Leaf 4");
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				SampleView4.this.fillContextMenu(manager);
			}
		});
...
//								showMessage("Action 1 executed");
				...
				TreeParent to1 = new TreeParent("Leaf 1-1");
				treeObject.addChild(to1);
