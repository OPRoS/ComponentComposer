...
public class EventOutputPortModel extends PortModel{
	String typeName = "EventOutputPortModel";
	...
	public EventOutputPortModel(PortContainerModel p) {
	       super(p);
		...
		public EventOutputPortModel() {
			  super();
			  this.setUsage("output");
	    }

	    public EventOutputPortModel(UMLDataModel p) {
	    	  super(p);
	    	  this.setUsage("output");
	    }
	    
	    public Object clone() {
	    	EventOutputPortModel clone = new EventOutputPortModel((UMLDataModel)this.getUMLDataModel().clone());
