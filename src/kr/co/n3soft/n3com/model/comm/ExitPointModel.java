...
public class ExitPointModel extends PortModel {
    ...
    public ExitPointModel(UMLDataModel p) {
        name = (ElementLabelModel)p.getElementProperty("NAME");
        this.setAttachElementLabelModel(name);
        this.setUMLDataModel(p);
    }

    public ExitPointModel(PortContainerModel p) {
        this.size.height = 15;
        this.size.width = 15;
        this.portCm = p;
        name = new ElementLabelModel();
    ...
    public Object clone() {
        ExitPointModel clone = new ExitPointModel((UMLDataModel)this.getUMLDataModel().clone());
