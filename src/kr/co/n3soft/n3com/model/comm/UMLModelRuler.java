...
public class UMLModelRuler implements Serializable {
    ...
    public UMLModelRuler(boolean isHorizontal) {
        this(isHorizontal, RulerProvider.UNIT_PIXELS);
    }

    public UMLModelRuler(boolean isHorizontal, int unit) {
        horizontal = isHorizontal;
        setUnit(unit);
    }

    public void addGuide(UMLModelGuide guide) {
    ...
    public void removeGuide(UMLModelGuide guide) {
