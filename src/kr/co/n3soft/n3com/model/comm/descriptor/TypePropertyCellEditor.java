...
import kr.co.n3soft.n3com.project.dialog.ModelRefDialog;
...
public class TypePropertyCellEditor extends DialogCellEditor {
     ...
     */
    public TypePropertyCellEditor(Composite parent) {
     ...
     * @since 2.1
     */
    public TypePropertyCellEditor(Composite parent, int style) {
        super(parent, style);
        doSetValue("");
    }
    ...
    protected Object openDialogBox(Control cellEditorWindow) {
    	...
    	ModelRefDialog dialog = new ModelRefDialog(cellEditorWindow.getShell());
