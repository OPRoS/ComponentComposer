...
public class MessagePropertiestCellEditor extends DialogCellEditor {
     ...
     */
    public MessagePropertiestCellEditor(Composite parent) {
     ...
     * @since 2.1
     */
    public MessagePropertiestCellEditor(Composite parent, int style) {
        super(parent, style);
        doSetValue("");
    }
