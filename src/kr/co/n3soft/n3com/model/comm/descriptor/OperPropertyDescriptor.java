...
public class OperPropertyDescriptor extends PropertyDescriptor {
    ...
    public OperPropertyDescriptor(Object id, String displayName) {
    ...
    public CellEditor createPropertyEditor(Composite parent) {
        CellEditor editor = new OperationCellEditor(parent);
