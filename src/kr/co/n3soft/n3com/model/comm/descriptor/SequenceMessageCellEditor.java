...
public class SequenceMessageCellEditor extends DialogCellEditor {
     ...
     */
    public SequenceMessageCellEditor(Composite parent) {
     ...
     * @since 2.1
     */
    public SequenceMessageCellEditor(Composite parent, int style) {
        super(parent, style);
        doSetValue("");
    }
    ...
    protected Object openDialogBox(Control cellEditorWindow) {
    	...
    	SeqMessageDialog dialog = new SeqMessageDialog(cellEditorWindow.getShell());
