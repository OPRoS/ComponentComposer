...
public class DetailPropertyDescriptor extends PropertyDescriptor {
   ...
   public DetailPropertyDescriptor(Object id, String displayName) {
   ...
   public CellEditor createPropertyEditor(Composite parent) {
       CellEditor editor = new DetailPorpertyCellEditor(parent);
