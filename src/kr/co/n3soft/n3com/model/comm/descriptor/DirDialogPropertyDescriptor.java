...
public class DirDialogPropertyDescriptor extends PropertyDescriptor {
   ...
   public DirDialogPropertyDescriptor(Object id, String displayName) {
   ...
   public CellEditor createPropertyEditor(Composite parent) {
       CellEditor editor = new DirDialogPropertyCellEditor(parent);
