...
public class AttrPropertyDescriptor extends PropertyDescriptor {
    ...
    public AttrPropertyDescriptor(Object id, String displayName) {
    ...
    public CellEditor createPropertyEditor(Composite parent) {
        CellEditor editor = new AttributeCellEditor(parent);
