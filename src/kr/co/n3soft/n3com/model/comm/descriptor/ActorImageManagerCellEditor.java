...
import kr.co.n3soft.n3com.project.dialog.ActorImageManagerDialog;
...
public class ActorImageManagerCellEditor extends DialogCellEditor {
     ...
     */
    public ActorImageManagerCellEditor(Composite parent) {
     ...
     * @since 2.1
     */
    public ActorImageManagerCellEditor(Composite parent, int style) {
        super(parent, style);
        doSetValue("");
    }
    ...
    protected Object openDialogBox(Control cellEditorWindow) {
    	...
    	ActorImageManagerDialog dialog = new ActorImageManagerDialog(cellEditorWindow.getShell());
