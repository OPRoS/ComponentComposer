...
public class DirDialogPropertyCellEditor extends DialogCellEditor {
     ...
     */
    public DirDialogPropertyCellEditor(Composite parent) {
     ...
     * @since 2.1
     */
    public DirDialogPropertyCellEditor(Composite parent, int style) {
        super(parent, style);
        doSetValue("");
    }
    ...
    protected Object openDialogBox(Control cellEditorWindow) {
    	...
    	DirectoryDialog dialog = new DirectoryDialog(cellEditorWindow.getShell(),SWT.SINGLE);
//    	java.util.List list = ProjectManager.getInstance().getSelectNodes();
    	UMLModel um = ProjectManager.getInstance().getSelectedModel();
    	if(um!=null){
    		dialog.setFilterPath(um.getSrcFolder());
    	}
