...
public class DetailPorpertyCellEditor extends DialogCellEditor {
     ...
     */
    public DetailPorpertyCellEditor(Composite parent) {
     ...
     * @since 2.1
     */
    public DetailPorpertyCellEditor(Composite parent, int style) {
        super(parent, style);
        doSetValue("");
    }
    ...
    protected Object openDialogBox(Control cellEditorWindow) {
    	...
    	DetailPropertyDiaolg dialog = new DetailPropertyDiaolg(cellEditorWindow.getShell());
