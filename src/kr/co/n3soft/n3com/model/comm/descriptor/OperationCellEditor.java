...
public class OperationCellEditor extends DialogCellEditor {
     ...
     */
    public OperationCellEditor(Composite parent) {
     ...
     * @since 2.1
     */
    public OperationCellEditor(Composite parent, int style) {
        super(parent, style);
        doSetValue("");
    }
    ...
    protected Object openDialogBox(Control cellEditorWindow) {
        ...
        OperationDialog dialog = new OperationDialog(cellEditorWindow.getShell());
