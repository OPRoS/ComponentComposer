...
import kr.co.n3soft.n3com.project.dialog.TextAreaDialog;
...
public class TextAreaCellEditor extends DialogCellEditor {
     ...
     * @since 2.1
     */
    public TextAreaCellEditor(Composite parent, int style) {
        super(parent, style);
        doSetValue("");
    }
    ...
    protected void updateContents(Object value) {
        Object obj = value;
        if (obj != null)
            rgbLabel.setText((String)value); //$NON-NLS-4$//$NON-NLS-3$//$NON-NLS-2$//$NON-NLS-1$
    }
}
