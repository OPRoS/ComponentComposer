...
import kr.co.n3soft.n3com.project.dialog.PatternModelRefDialog;
...
public class CommunicationMessageCellEditor extends DialogCellEditor {
     ...
     */
    public CommunicationMessageCellEditor(Composite parent) {
     ...
     * @since 2.1
     */
    public CommunicationMessageCellEditor(Composite parent, int style) {
        super(parent, style);
        doSetValue("");
    }
    ...
    protected Object openDialogBox(Control cellEditorWindow) {
    	...
    	CommunicationMessagePropertyDialog dialog = new CommunicationMessagePropertyDialog(cellEditorWindow.getShell());
