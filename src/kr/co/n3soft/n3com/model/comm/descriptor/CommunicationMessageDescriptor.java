...
public class CommunicationMessageDescriptor extends PropertyDescriptor {
   ...
   public CommunicationMessageDescriptor(Object id, String displayName) {
   ...
   public CellEditor createPropertyEditor(Composite parent) {
       CellEditor editor = new CommunicationMessageCellEditor(parent);
