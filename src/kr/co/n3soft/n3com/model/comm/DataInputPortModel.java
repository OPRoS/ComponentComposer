...
public class DataInputPortModel extends PortModel{
	String typeName = "DataInputPortModel";
	...
	public DataInputPortModel(PortContainerModel p) {
	       super(p);
		...
		public DataInputPortModel() {
			  super();
			  this.setUsage("input");
	    }

	    public DataInputPortModel(UMLDataModel p) {
	    	  super(p);
	    	  this.setUsage("input");
	    }
	    
	    public Object clone() {
	    	DataInputPortModel clone = new DataInputPortModel((UMLDataModel)this.getUMLDataModel().clone());
