...
public class DeviceModel extends ClassifierModel {
    ...
    public DeviceModel() {
        ...
        //		default_width = 80;
        //		default_height = 50;
//        this.setBackGroundColor(ColorConstants.);
        this.setAttrIsBorder(false);
        this.setOperIsBorder(false);
        
//        this.getClassModel().setComponent(true);
        		this.setStereotype("device");
    }
    
    public DeviceModel(UMLDataModel p,boolean isLoad) {
        super(p,isLoad);
//        this.setUMLDataModel(p);
    ...
    //
    //	}
    public DeviceModel(UMLDataModel p) {
        super(p);
...
//        this.getClassModel().setComponent(true);
    ...
    public Object clone() {
    	DeviceModel clone = new DeviceModel((UMLDataModel)this.getUMLDataModel().clone());
