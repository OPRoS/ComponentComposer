...
public class ReceiveModel extends UMLDiagramModel {
    ...
    //		}
    //	}
    public ReceiveModel(UMLDataModel p) {
        size.width = 100;
        size.height = 50;
        streotype = new ElementLabelModel(PositionConstants.CENTER);
    ...
    public Object clone() {
        ReceiveModel clone = new ReceiveModel((UMLDataModel)this.getUMLDataModel().clone());
