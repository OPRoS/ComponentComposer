...
public class CallOperationModel extends UMLDiagramModel {
    ...
    private UMLModel callBehaviorParent;
    ...
    //		};
    //	}
    public CallOperationModel() {
        size.width = 10;
        size.height = 10;
    }

    public CallOperationModel(UMLModel p) {
        size.width = 10;
        size.height = 10;
        this.callBehaviorParent = p;
    }
    ...
    //	}
    public Object clone() {
        CallOperationModel clone = new CallOperationModel();
