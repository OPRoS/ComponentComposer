...
public class FinalObjectNodeModel extends ClassifierModel {
...
//        barModel.setAcceptParentModel(this);
    ...
    public FinalObjectNodeModel(UMLDataModel p,boolean isLoad) {
        super(p,isLoad);
//        this.setUMLDataModel(p);
    }
    public FinalObjectNodeModel(UMLDataModel p) {
        super(p);
...
//        barModel.setAcceptParentModel(this);
    ...
    public Object clone() {
        FinalObjectNodeModel clone = new FinalObjectNodeModel((UMLDataModel)this.getUMLDataModel().clone());
