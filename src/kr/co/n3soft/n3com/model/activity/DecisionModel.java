...
public class DecisionModel extends TextAttachModel {
    ...
    public DecisionModel(UMLDataModel p) {
    ...
    public DecisionModel(ExceptionModel p) {
        this.size.height = 30;
        this.size.width = 30;
        name = new ElementLabelModel();
        name.setType("NAME");
    ...
    //	}
    public Object clone() {
        DecisionModel clone = new DecisionModel((UMLDataModel)this.getUMLDataModel().clone());
