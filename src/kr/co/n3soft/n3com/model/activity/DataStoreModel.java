...
public class DataStoreModel extends ClassifierModel {
...
//        barModel.setAcceptParentModel(this);
    ...
    public DataStoreModel(UMLDataModel p,boolean isLoad) {
        super(p,isLoad);
//        this.setUMLDataModel(p);
    }
    public DataStoreModel(UMLDataModel p) {
        super(p);
...
//        barModel.setAcceptParentModel(this);
    ...
    public Object clone() {
    	DataStoreModel clone = new DataStoreModel((UMLDataModel)this.getUMLDataModel().clone());
