...
public class VForkJoinModel extends TextAttachModel {
    ...
    public VForkJoinModel(UMLDataModel p) {
    ...
    public VForkJoinModel(ExceptionModel p) {
        this.size.height = 100;
        this.size.width = 10;
        name = new ElementLabelModel();
        name.setType("NAME");
    ...
    //	}
    public Object clone() {
        VForkJoinModel clone = new VForkJoinModel((UMLDataModel)this.getUMLDataModel().clone());
