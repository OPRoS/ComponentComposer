...
public class ExpansionNodeModel extends PortModel {
    public ExpansionNodeModel() {
    ...
    public ExpansionNodeModel(UMLDataModel p) {
        name = (ElementLabelModel)p.getElementProperty("NAME");
        this.setAttachElementLabelModel(name);
        this.setUMLDataModel(p);
    }

    public ExpansionNodeModel(PortContainerModel p) {
        this.size.height = 15;
        this.size.width = 45;
        this.portCm = p;
        name = new ElementLabelModel();
