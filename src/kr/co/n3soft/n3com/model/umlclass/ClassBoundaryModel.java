...
public class ClassBoundaryModel extends UMLDiagramModel {
    ...
    ////			UseCaseModel um = (UseCaseModel)child;
    ////			um.setLocation(this.getParentModel().getLocation());
    ////			return;
    ////		}
    //		try{
    //		
    ...
    public Object clone() {
        ClassBoundaryModel clone = new ClassBoundaryModel();
