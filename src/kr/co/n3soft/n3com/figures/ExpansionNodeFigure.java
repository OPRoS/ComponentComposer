...
public class ExpansionNodeFigure extends UMLFigure implements HandleBounds {
    ...
    protected void paintFigure(Graphics graphics) {
        ...
        r1.setBounds(new Rectangle(r.x, r.y, width, height));
        Rectangle r2 = Rectangle.SINGLETON;
        r2.setBounds(new Rectangle(r.x + r.width / 3, r.y, width, height));
        Rectangle r3 = Rectangle.SINGLETON;
        r3.setBounds(new Rectangle(r.x + r.width / 3 * 2, r.y, width, height));
