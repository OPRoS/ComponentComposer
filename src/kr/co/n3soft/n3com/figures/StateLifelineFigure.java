...
public class StateLifelineFigure extends UMLFigure implements HandleBounds {
  ...
  //PKY 08081101 S Timing 구조 변경
    ...
    private java.util.HashMap xData = new java.util.HashMap();
  ...
  //PKY 08081101 E Timing 구조 변경
    ...
    public StateLifelineFigure() {
        setBorder(new StateLifeLineBorder());
	...
	public java.util.ArrayList getTransitionEventModels() {
		return transitionEventModels;
	}

	public void setTransitionEventModels(java.util.ArrayList transitionEventModels) {
		this.transitionEventModels = transitionEventModels;
	}

	public java.util.HashMap getXData() {
		return xData;
	}

	public void setXData(java.util.HashMap data) {
		xData = data;
	}
