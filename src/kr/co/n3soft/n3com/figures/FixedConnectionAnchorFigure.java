...
public class FixedConnectionAnchorFigure extends AbstractConnectionAnchor {
    public boolean leftToRight = true;
    public int offsetH;
    public int offsetV;
    public boolean topDown = true;

    public FixedConnectionAnchorFigure(IFigure owner) {
        super(owner);
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof FixedConnectionAnchorFigure) {
            FixedConnectionAnchorFigure fa = (FixedConnectionAnchorFigure)o;
