...
public class StrcuturedStateFigure extends UMLFigure implements HandleBounds {
    private IFigure pane;
    private TextFlow textFlow;

    public StrcuturedStateFigure() {
    ...
    protected void paintFigure(Graphics graphics) {
      ...
      //PKY 08081101 S subMachineState 구조 변경
        int x1 = r.x + r.width - 20;
        int y1 = r.y + r.height - 15;
        int width = 15;
        int height = 10;
      ...
      //PKY 08081101 E subMachineState 구조 변경
