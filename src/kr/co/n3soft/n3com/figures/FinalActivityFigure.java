...
public class FinalActivityFigure extends UMLFigure implements HandleBounds {
    ...
    public FinalActivityFigure() {
        setBorder(new FinalActivityBorder());
    ...
    protected void paintFigure(Graphics graphics) {
        ...
        if(this.parameterName!=null && parameterName.trim().length()>0){
        	
        	graphics.drawString("parameter name : "+parameterName, x,y);
        }
        if(this.preCondition!=null && preCondition.trim().length()>0){
        	graphics.drawString("<<precondition>> "+preCondition, x,y+22);
        }
        if(this.postCondition!=null && postCondition.trim().length()>0){
        	graphics.drawString("<<postcondition>>"+postCondition, x,y+34);
        }
