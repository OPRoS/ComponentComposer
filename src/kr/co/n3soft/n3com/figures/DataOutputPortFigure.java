...
public class DataOutputPortFigure extends UMLFigure implements HandleBounds {
    private IFigure pane;
    private TextFlow textFlow;
    private Image image; // WJH 090801
    private Image image2;	// WJH 090819

    public DataOutputPortFigure() {
...
//      	 WJH 090819 S
      	 if(image == null){
	        	image = ProjectManager.getInstance().getImageReSize(10003, r.width, r.height);
	        	image2 = ProjectManager.getInstance().getImageReSize(10012, 32, 32);
	        }
//	 	  WJH 090818 E
	        if(image != null){
...
//            pt.addPoint(x1, y1-(int)(height * REC_PERCENT) );
//            pt.addPoint((int)(width / 2) + x1, y1-height);
//            pt.addPoint(width + x1, y1-(int)(height * REC_PERCENT) );
//            pt.addPoint(width + x1, y1);
//            graphics.setBackgroundColor(ColorConstants.orange);
//            Rectangle circle = new Rectangle(x1+5,y1-35,10,10);
...
//             PointList pt = new PointList();
//             pt.addPoint(x1, y1);
//             pt.addPoint((int)(width * REC_PERCENT) + x1, y1);
//             pt.addPoint(width + x1, (int)(height / 2) + y1);
//             pt.addPoint((int)(width * REC_PERCENT) + x1, height + y1);
...
//            PointList pt = new PointList();
//            pt.addPoint(x1, y1);
//            pt.addPoint(x1-(int)(width * REC_PERCENT) , y1);
//            pt.addPoint(x1-width, (int)(height / 2) + y1);
//            pt.addPoint(x1-(int)(width * REC_PERCENT), height + y1);
//            pt.addPoint(x1, height + y1);
//            Rectangle circle = new Rectangle(x1-width-15,y1+5,10,10);
//            this.setBackgroundColor(ColorConstants.orange);
//            graphics.fillPolygon(pt);
//                graphics.drawPolyline(pt);
//                graphics.setBackgroundColor(ColorConstants.orange);
