...
public class SynchFigure extends UMLFigure implements HandleBounds {
    private IFigure pane;
    private TextFlow textFlow;

    public SynchFigure() {
        setBorder(new SynchBorder());
    ...
    protected void paintFigure(Graphics graphics) {
        ...
        int width = r.width;
        int height = r.height;
        graphics.fillOval(r.x + 3, r.y + 3, width - 4, height - 4);
        graphics.drawLine(r.x + 5, r.y + 7, r.x + width - 5, r.y + height - 5);
        graphics.drawLine(r.x + width - 5, r.y + 7, r.x + 5, r.y + height - 5);
        graphics.drawLine(r.x + width / 2, r.y + 7, r.x + width / 2, r.y + height - 5);
        graphics.drawLine(r.x + 5, r.y + height / 2, r.x + width, r.y + height / 2);
