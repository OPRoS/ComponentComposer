...
public class ExitPointFigure extends UMLFigure implements HandleBounds {
    private IFigure pane;
    private TextFlow textFlow;

    public ExitPointFigure() {
        setBorder(new EntryPointBorder());
    ...
    protected void paintFigure(Graphics graphics) {
        ...
        //	graphics.drawLine(r.x+1, r.y+1, r.x+width-3, r.y+height-3);
        //	graphics.drawLine(r.x+width-3, r.y-3, r.x, r.y+height-3);
        graphics.drawLine(r.x, r.y, r.x + width, r.y + height);
        graphics.drawLine(r.x + width, r.y, r.x, r.y + height);
