...
public class ContainerBoundaryFigure extends UMLFigure implements HandleBounds {
    private IFigure pane;
    private TextFlow textFlow;

    public ContainerBoundaryFigure() {
        //	BoundaryBorder
    ...
    protected void paintFigure(Graphics graphics) {
        ...
        int tenValue = r.width/10;
        graphics.setForegroundColor(ColorConstants.black);
        
        
////        graphics.drawString("10ddd", r.x+20, r.y+r.height-50);	
//        for(int i=0;i<=10;i++){
//        	
//        	graphics.drawString(String.valueOf(i*10), r.x+(i*tenValue), r.y+50);	
//        }
