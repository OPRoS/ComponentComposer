...
public class HistoryFigure extends UMLFigure implements HandleBounds {
    ...
    protected void paintFigure(Graphics graphics) {
        ...
        if (!isDeepHistory) {
            graphics.drawLine(r.x + 7, r.y + 7, r.x + 7, r.y + height - 5);
            graphics.drawLine(r.x + 19, r.y + 7, r.x + 19, r.y + height - 5);
            graphics.drawLine(r.x + 7, r.y + 2 + height / 2, r.x + 19, r.y + 2 + height / 2);
        }
        else {
            graphics.drawLine(r.x + 7, r.y + 7, r.x + 7, r.y + height - 5);
            graphics.drawLine(r.x + 15, r.y + 7, r.x + 15, r.y + height - 5);
            graphics.drawLine(r.x + 7, r.y + 2 + height / 2, r.x + 15, r.y + 2 + height / 2);
            graphics.drawLine(r.x + 17, r.y + height / 2, r.x + 20, r.y + height / 2);
            graphics.drawLine(r.x + 17 + 4 / 2, r.y + height / 2, r.x + 17 + 4 / 2, r.y + height / 2 - 3);
            graphics.drawLine(r.x + 17 + 4 / 2, r.y + height / 2, r.x + 17, r.y + height / 2 + 5);
            graphics.drawLine(r.x + 17 + 4 / 2, r.y + height / 2, r.x + 20, r.y + height / 2 + 5);
        }
