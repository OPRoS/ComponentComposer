...
public class EventOutputPortFigure extends UMLFigure implements HandleBounds {
    private IFigure pane;
    private TextFlow textFlow;
    private Image image; //WJH 090801
    private Image image2; // WJH 090819

    public EventOutputPortFigure() {
...
//      	 WJH 090819 S
           if(image == null){
        	   image = ProjectManager.getInstance().getImageReSize(10005, r.width, r.height);     	
        	   image2 = ProjectManager.getInstance().getImageReSize(10014, 32, 32);
           }
//         WJH 090818 E
           if(image != null){
...
////          	 int x2 = x+height/2-1;
////          	 int y2 = y-1;
//          	 r2 = new Rectangle(x1,y1+21,20,20);
//          	 r4 = new Rectangle(x1,y1+31,widht,height);
...
//          	graphics.fillArc( r2, 360, 180);
//          	 graphics.drawArc(r2, 360, 180);
...
//            r2 = new Rectangle(x1,y1,20,20);
//          	 r4 = new Rectangle(x1-29,y1,widht,height);
//          	Rectangle circle = new Rectangle(x1+25,y1+5,10,10);
//          	 graphics.setBackgroundColor(ColorConstants.lightBlue);
//          	 graphics.fillRectangle(r4);
//          	 graphics.drawRectangle(r4);
////          	 graphics.setBackgroundColor(ColorConstants.white);
...
//          	 int y1 = y;
//          	 r2 = new Rectangle(x1,y1,20,20);
//          	 r4 = new Rectangle(x1,y1-29,widht,height);
...
//              	 int x1 = x;
//              	 int y1 = y+r.height/2-10;
//                r2 = new Rectangle(x1+20,y1,20,20);
//              	 r4 = new Rectangle(x1+30,y1,widht,height);
//              	Rectangle circle = new Rectangle(x1+5,y1+5,10,10);
//              	 graphics.setBackgroundColor(ColorConstants.lightBlue);
//              	 graphics.fillRectangle(r4);
//              	 graphics.drawRectangle(r4);
