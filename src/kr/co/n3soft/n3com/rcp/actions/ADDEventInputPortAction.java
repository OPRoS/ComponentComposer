...
public class ADDEventInputPortAction extends SelectionAction {
    public ADDEventInputPortAction(IEditorPart editor) {
        super(editor);
        this.setId("ADDEventInputPortAction");
        this.setText("Event InputPort");
        setImageDescriptor(ImageDescriptor.createFromImage(ProjectManager.getInstance().getImage(10004))); // WJH 090810
    }
