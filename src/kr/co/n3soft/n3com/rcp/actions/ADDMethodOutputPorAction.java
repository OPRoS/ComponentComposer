...
public class ADDMethodOutputPorAction extends SelectionAction {
    public ADDMethodOutputPorAction(IEditorPart editor) {
        super(editor);
        this.setId("ADDMethodOutputPorAction");
        this.setText("Service Provided");
        setImageDescriptor(ImageDescriptor.createFromImage(ProjectManager.getInstance().getImage(10006))); // WJH 090810
    }
