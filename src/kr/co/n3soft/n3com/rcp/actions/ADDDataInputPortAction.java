...
public class ADDDataInputPortAction extends SelectionAction {
    public ADDDataInputPortAction(IEditorPart editor) {
        super(editor);
        this.setId("ADDDataInputPortAction");
        this.setText("Data InputPort");
        setImageDescriptor(ImageDescriptor.createFromImage(ProjectManager.getInstance().getImage(10002))); // WJH 090810
    }
