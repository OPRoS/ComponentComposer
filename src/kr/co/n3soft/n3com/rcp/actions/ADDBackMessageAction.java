...
public class ADDBackMessageAction extends SelectionAction {
    public ADDBackMessageAction(IEditorPart editor) {
        super(editor);
        this.setId("ADDBackMessageAction");
...
//        StructuredSelection list = (StructuredSelection)this.getSelection();
        if (list != null && list.size() == 1) {
            ...
            if (obj instanceof MessageAssoicateLineEditPart) {
            	...
            	this.setText(N3Messages.POPUP_ADD_MESSAGE+" from "+ut.getName()+" to "+us.getName());//PKY 08070701 S 커뮤니케이션 이름 변경
               return true;
            }
        }
        return false;
