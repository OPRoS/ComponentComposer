...
public class ADDEventOutputPortAction extends SelectionAction {
    public ADDEventOutputPortAction(IEditorPart editor) {
        super(editor);
        this.setId("ADDEventOutputPortAction");
        this.setText("Event OutputPort");
        setImageDescriptor(ImageDescriptor.createFromImage(ProjectManager.getInstance().getImage(10005))); // WJH 090810
    }
...
//            					if(pm instanceof MethodOutputPortModel)
            					...
            					pm2.getElementLabelModel().setPortId(pm.getUMLDataModel().getId());
