...
public class ADDActivityParameterAction extends SelectionAction {
    public ADDActivityParameterAction(IEditorPart editor) {
        super(editor);
        this.setId("ADD ActivityParameter");
        this.setText(N3Messages.POPUP_ADD_ACTIVITY_PARAMETER);
    ...
    public void run() {
        ...
        if (list != null && list.size() == 1) {
            ...
            if (obj instanceof UMLEditPart) {
                ...
                um.createPort(new ActivityParameterModel(um), (UMLContainerModel)um.getAcceptParentModel());
            }
        }
    }
}
