...
public class N3IncrementDecrementAction extends org.eclipse.gef.ui.actions.SelectionAction {
    ...
    public N3IncrementDecrementAction(IWorkbenchPart part, boolean increment) {
        super(part);
        if (increment) {
