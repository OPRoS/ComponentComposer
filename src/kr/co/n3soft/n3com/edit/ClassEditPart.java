...
import kr.co.n3soft.n3com.figures.ClassFigure;
...
public class ClassEditPart extends UMLContainerEditPart {
    ...
    protected void refreshVisuals() {
        ...
        //			getFigure(),
        //			r);
        if (getUMLModel() instanceof ClassModel) {
            ClassModel actorModel = (ClassModel)getUMLModel();
            boolean isCom = actorModel.getComponent();
            boolean isArt = actorModel.getIsArtiface();
            ClassFigure cf = (ClassFigure)getFigure();
            cf.setIsComponent(isCom);
