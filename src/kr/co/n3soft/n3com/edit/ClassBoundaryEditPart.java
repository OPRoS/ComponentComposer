...
import kr.co.n3soft.n3com.figures.ClassBoundaryFigure;
...
public class ClassBoundaryEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        //		UseCaseFigure
        ClassBoundaryFigure figure = new ClassBoundaryFigure();
        return figure;
    }
    ...
    protected ClassBoundaryFigure getBoundaryFigureBoardFigure() {
        return (ClassBoundaryFigure)getFigure();
    }
    ...
    protected void refreshVisuals() {
        ...
        if (getUMLModel() instanceof ClassBoundaryModel) {
            ClassBoundaryModel actorModel = (ClassBoundaryModel)getUMLModel();
