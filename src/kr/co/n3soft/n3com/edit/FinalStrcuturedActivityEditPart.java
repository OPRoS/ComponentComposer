...
import kr.co.n3soft.n3com.figures.FinalStrcuturedActivityBorder;
import kr.co.n3soft.n3com.figures.FinalStrcuturedActivityFigure;
...
public class FinalStrcuturedActivityEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        FinalStrcuturedActivityFigure figure = new FinalStrcuturedActivityFigure();
        BorderLayout flowLayout = new BorderLayout();
        figure.setLayoutManager(flowLayout);
        figure.setOpaque(false);
        if (this.getModel() instanceof FinalStrcuturedActivityModel) {
            FinalStrcuturedActivityModel fsm = (FinalStrcuturedActivityModel)this.getModel();
            if (fsm.getType() > 1) {
                figure.setBorder(new FinalStrcuturedActivityBorder());
            }
        }
        return figure;
    }
