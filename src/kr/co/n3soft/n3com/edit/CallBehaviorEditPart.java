...
import kr.co.n3soft.n3com.figures.CallBehaviorFigure;
...
public class CallBehaviorEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        CallBehaviorFigure figure = new CallBehaviorFigure();
    ...
    protected void refreshVisuals() {
        ...
        if (getUMLModel() instanceof CallBehaviorModel) {
            CallBehaviorModel actorModel = (CallBehaviorModel)getUMLModel();
...
//            if(getFigure() instanceof CallBehaviorFigure){
//            	CallBehaviorFigure mcf = (CallBehaviorFigure)getFigure();
//            	mcf.setModel(getUMLModel());
//            }
