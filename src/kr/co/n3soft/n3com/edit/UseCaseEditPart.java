...
import kr.co.n3soft.n3com.figures.UseCaseFigure;
...
public class UseCaseEditPart extends UMLContainerEditPart {
    public UseCaseEditPart() {
    ...
    protected void refreshVisuals() {
        try {
            ...
            if(getFigure() instanceof UseCaseFigure){
            	UseCaseFigure uf = (UseCaseFigure)getFigure();
            	uf.setExtendsPoints(getUMLModel().getExtendsPoints());
            	//2008041401PKY S
            	Object Usecase=this.getModel();
            	if(Usecase instanceof UseCaseModel){
            		UseCaseModel uModel=(UseCaseModel)Usecase;
            		Dimension Size =   uModel.getSize();
            		if(uModel.getUMLTreeModel()!=null){
            			if(uModel.getUMLTreeModel() instanceof StrcuturedPackageTreeModel){
            				StrcuturedPackageTreeModel strcuturedPackageTreeModel = (StrcuturedPackageTreeModel)uModel.getUMLTreeModel();
