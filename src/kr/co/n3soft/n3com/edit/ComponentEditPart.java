...
import kr.co.n3soft.n3com.figures.ComponentFigure;
...
public class ComponentEditPart extends UMLContainerEditPart {
...
//        WJH 090807 S
        ComponentModel model = (ComponentModel)this.getModel();        
        figure.setModel(model);
        figure.setEditpart(this.getParent());
        System.out.println("Diagram EditPart : "+this.getParent().toString());
//      WJH 090807 E
