...
import kr.co.n3soft.n3com.figures.EntryPointFigure;
...
public class EntryPointEditPart extends UMLContainerEditPart {
    public EntryPointEditPart() {
    }
    ...
    protected void refreshVisuals() {
        try {
            ...
            Dimension size = new Dimension(15,15); //2008040102 PKY S Port및 여러 추가적으로 들어갈 수 있는 객체 사이즈 조정못하도록 수정 
			   //2008040102 PKY S  Dimension size = getUMLModel().getSize();
