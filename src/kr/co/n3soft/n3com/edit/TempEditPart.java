...
import kr.co.n3soft.n3com.figures.TempFigure;
...
public class TempEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        //		UseCaseFigure
        TempFigure figure = new TempFigure();
    ...
    protected void refreshVisuals() {
        ...
        if (getUMLModel() instanceof TempModel) {
            TempModel actorModel = (TempModel)getUMLModel();
