...
import kr.co.n3soft.n3com.figures.BorderContainlFigure;
...
public class BorderContainEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        //		UseCaseFigure
        BorderContainlFigure figure = new BorderContainlFigure();
    ...
    protected void refreshVisuals() {
        ...
        if (getUMLModel() instanceof BorderContainlModel) {
            BorderContainlModel actorModel = (BorderContainlModel)getUMLModel();
