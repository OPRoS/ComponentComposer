...
import kr.co.n3soft.n3com.figures.BarFigure;
...
public class BarEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        //		UseCaseFigure
        BarFigure figure = new BarFigure();
    ...
    protected void refreshVisuals() {
        ...
        if (getUMLModel() instanceof BarModel) {
            BarModel actorModel = (BarModel)getUMLModel();
