...
public class UMLMainPackageEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        //		UseCaseFigure
        UMLMainPackageFigure figure = new UMLMainPackageFigure();
    ...
    protected void refreshVisuals() {
        ...
        if (getUMLModel() instanceof UMLMainPackageModel) {
            UMLMainPackageModel actorModel = (UMLMainPackageModel)getUMLModel();
