...
public class ActionEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        ...
        if (this.getModel() instanceof NodeContainerModel) {
            NodeContainerModel n = (NodeContainerModel)this.getModel();
            n.fi = figure;
        }
        return figure;
    }
    ...
    protected ActionFigure getActionFigureBoardFigure() {
        return (ActionFigure)getFigure();
    }

    public IFigure getContentPane() {
        return getActionFigureBoardFigure().getContentsPane();
    }
    ...
    protected void refreshVisuals() {
        ...
        if (getUMLModel() instanceof NodeContainerModel) {
            NodeContainerModel actorModel = (NodeContainerModel)getUMLModel();
    ...
    //		;
    ////		if(value==2){
    ////			ProjectManager.getInstance().setSelectContainModel((UMLModel)this.getModel());
    ////		}
    ////		Tool tool = ProjectManager.getInstance().getUMLEditor().getUMLDefaultEditDomain().getActiveTool();
    ////			if(!(tool instanceof MarqueeSelectionTool) ){
    ////				if(value==2){
