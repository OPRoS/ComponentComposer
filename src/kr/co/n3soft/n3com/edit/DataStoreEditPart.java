...
import kr.co.n3soft.n3com.figures.DataStoreFigure;
...
public class DataStoreEditPart extends UMLContainerEditPart {
    ...
    protected void refreshVisuals() {
        ...
        if(getFigure() instanceof DataStoreFigure){
        	DataStoreFigure fa = (DataStoreFigure)getFigure();
