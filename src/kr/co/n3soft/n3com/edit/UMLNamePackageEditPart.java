...
public class UMLNamePackageEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        //		UseCaseFigure
        UMLNamePackageFigure figure = new UMLNamePackageFigure();
    ...
    protected void refreshVisuals() {
        ...
        if (getUMLModel() instanceof UMLNamePackageModel) {
            UMLNamePackageModel actorModel = (UMLNamePackageModel)getUMLModel();
