...
import kr.co.n3soft.n3com.figures.CallOperationFigure;
...
public class CallOperationEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        CallOperationFigure figure = new CallOperationFigure();
    ...
    protected void refreshVisuals() {
        ...
        if (getUMLModel() instanceof CallOperationModel) {
            CallOperationModel actorModel = (CallOperationModel)getUMLModel();
