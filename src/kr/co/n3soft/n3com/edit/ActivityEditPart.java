...
public class ActivityEditPart extends UMLContainerEditPart {
    ...
    protected ActivityFigure getActivityFigureBoardFigure() {
        return (ActivityFigure)getFigure();
    }

    public IFigure getContentPane() {
        return getActivityFigureBoardFigure().getContentsPane();
    }

    protected void refreshVisuals() {
        //		((UMLElementFigure)getFigure()).setText(getElementLabelModel().getLabelContents());
        if (getUMLModel() instanceof ActivityModel) {
            ActivityModel actorModel = (ActivityModel)getUMLModel();
