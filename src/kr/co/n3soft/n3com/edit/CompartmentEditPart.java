...
import kr.co.n3soft.n3com.figures.CompartmentFigure;
...
public class CompartmentEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        ...
        CompartmentModel cm = (CompartmentModel)this.getModel();
        if (cm.getIsBorder()) {
            figure.setCompartmentFigureBorderBorder(new CompartmentFigureBorder());
        }
        return figure;
    }
    ...
    protected void refreshVisuals() {
        ...
        if (getUMLModel() instanceof CompartmentModel) {
            CompartmentModel actorModel = (CompartmentModel)getUMLModel();
