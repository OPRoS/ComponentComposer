...
import kr.co.n3soft.n3com.figures.SelfMessageFigure;
...
public class SelfMessageEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        //		UseCaseFigure
    	SelfMessageFigure figure = new SelfMessageFigure();
...
//        if(getFigure() instanceof FragmentFigure){
//        	FragmentModel fm = (FragmentModel)getUMLModel();
//        	FragmentFigure ff = (FragmentFigure)getFigure();
//        	ff.setType(fm.getType());
//        	ff.setFragmentName(fm.getFragmentName());
