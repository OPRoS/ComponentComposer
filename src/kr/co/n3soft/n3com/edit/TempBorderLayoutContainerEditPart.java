...
public class TempBorderLayoutContainerEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        //		UseCaseFigure
        TempBorderLayoutContainerFigure figure = new TempBorderLayoutContainerFigure();
    ...
    protected void refreshVisuals() {
        ...
        if (getUMLModel() instanceof TempBorderLayoutContainerModel) {
            TempBorderLayoutContainerModel actorModel = (TempBorderLayoutContainerModel)getUMLModel();
