...
import kr.co.n3soft.n3com.figures.ContainerBoundaryFigure;
...
public class ContainerBoundaryEditPart extends UMLContainerEditPart {
    ...
    protected IFigure createFigure() {
        //		UseCaseFigure
    	ContainerBoundaryFigure figure = new ContainerBoundaryFigure();
        return figure;
    }
    ...
    protected ContainerBoundaryFigure getBoundaryFigureBoardFigure() {
        return (ContainerBoundaryFigure)getFigure();
    }
    ...
    protected void refreshVisuals() {
        ...
        if (getUMLModel() instanceof ContainerBoundaryModel) {
        	ContainerBoundaryModel actorModel = (ContainerBoundaryModel)getUMLModel();
