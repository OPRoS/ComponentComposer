...
public class UMLNoteEditManager extends DirectEditManager {
    ...
    public UMLNoteEditManager(GraphicalEditPart source, CellEditorLocator locator) {
    ...
    protected void initCellEditor() {
        // update text
        UMLNoteFigure stickyNote = (UMLNoteFigure)getEditPart().getFigure();
