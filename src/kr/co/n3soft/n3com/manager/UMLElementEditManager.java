package kr.co.n3soft.n3com.manager;
...
public class UMLElementEditManager extends DirectEditManager {
    ...
    public UMLElementEditManager(GraphicalEditPart source, CellEditorLocator locator) {
...
//        return new TextCellEditor(composite, SWT.MULTI | SWT.WRAP);
    ...
    protected void initCellEditor() {
        // update text
        UMLElementFigure stickyNote = (UMLElementFigure)getEditPart().getFigure();
