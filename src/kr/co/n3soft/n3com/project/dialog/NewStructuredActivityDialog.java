...
public class NewStructuredActivityDialog extends Dialog {
    ...
    public NewStructuredActivityDialog(Shell parentShell) {
        super(parentShell);
    }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        try {
            ...
            //this.initDesc();
        	comp.getShell().setText(N3Messages.DIALOG_NEW_STCUTUREACTIVITY);//20080717 KDI s
        	comp.getShell().setImage(ProjectManager.getInstance().getImage(26));//20080724 KDI s
    ...
    private TreeParent initialize() {
        TreeParent to1 = new TreeParent("Simple Composite", 1);
        TreeParent to2 = new TreeParent("Structured Activity Node", 2);
        TreeParent to3 = new TreeParent("Conditional Node", 3);
        TreeParent to4 = new TreeParent("Loop Node", 4);
        TreeParent to5 = new TreeParent("Sequential Node", 5);
        TreeParent p1 = new TreeParent("Select Activity Kind", 7);
        p1.addChild(to1);
        p1.addChild(to2);
        p1.addChild(to3);
        p1.addChild(to4);
        p1.addChild(to5);
        TreeParent root = new TreeParent("Structured Activity Model");
        root.addChild(p1);
        return root;
    }
